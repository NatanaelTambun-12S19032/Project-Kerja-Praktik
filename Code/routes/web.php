...
Route::get('/sidebar', 'App\Http\Controllers\Sidebar@index');
Route::get('/piechart', 'App\Http\Controllers\PieController@index');
Route::get('/dashboardsidebar', 'App\Http\Controllers\DashboardSidebar@index');
