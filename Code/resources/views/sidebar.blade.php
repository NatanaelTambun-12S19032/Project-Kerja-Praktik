        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">PraBAC</span> </a>
                    <div class="nav_list"> <a href="/sidebar" class="nav_link active"> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Dashboard</span> </a> <a href="/piechart" class="nav_link"> <i class='bx bx-user nav_icon'></i> <span class="nav_name">AP_DOWN</span> </div>
            ...
            <body style="width:100%">
                <div class="card-body container-fluid">
                    <div class="card mb-0 w-100 h-0">
                        <div class="form-group container-fluid w-full">
                                        ...
                                        <table id="dashboard" class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center" scope="col" style="background-color:#ED3237;color:white;">Terakhir Dilihat</th>
                                                    <th class="text-center" scope="col" style="background-color:#ED3237;color:white;">Created At</th>
                                                    <th class="text-center" scope="col" style="background-color:#ED3237;color:white;">Update At</th>
